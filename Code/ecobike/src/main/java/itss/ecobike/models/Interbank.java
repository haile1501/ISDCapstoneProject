...
public interface Interbank {
     ...
     * @return A <b><i>PaymentTransaction</i></b> record about the transaction <br> <i>null</i> if the transaction fails
     */
//    public Transaction returnDeposit(CreditCard creditCard, double amount, int rental_id);
     ...
     * @return A <b><i>PaymentTransaction</i></b> record about the transaction <br> <i>null</i> if the transaction fails
     */
//    public Transaction payRental(CreditCard creditCard, double amount, int rental_id);
